...
/* harmony import */ var _bewers_bewers_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./bewers/bewers.component */ "./src/app/bewers/bewers.component.ts");
...
var appRoutes = [
    ...
    {
        path: 'bewer',
        component: _bewers_bewers_component__WEBPACK_IMPORTED_MODULE_7__["BewersComponent"],
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _beers_beers_component__WEBPACK_IMPORTED_MODULE_6__["BeersComponent"],
                _bewers_bewers_component__WEBPACK_IMPORTED_MODULE_7__["BewersComponent"],
...
module.exports = "<h2>Beer List</h2>\n\n<ul class=\"beers\">\n  <li *ngFor=\"let p of beers; let i=index;\">\n    <a routerLink=\"/beer-details/{{p.id_beer}}\">\n      <span class=\"badge\">{{i+1}}</span> {{p.beer_name}}\n    </a>\n  </li>\n</ul>"
...
var BeersComponent = /** @class */ (function () {
    function BeersComponent(rest, route, router) {
        this.rest = rest;
        this.route = route;
        this.router = router;
        this.beers = [];
    ...
    BeersComponent.prototype.getBeers = function () {
        var _this = this;
        this.beers = [];
        this.rest.getBeers().subscribe(function (data) {
            console.log(data);
            _this.beers = data;
        });
    };
...
/***/ "./src/app/bewers/bewers.component.css":
/*!*********************************************!*\
  !*** ./src/app/bewers/bewers.component.css ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/app/bewers/bewers.component.html":
/*!**********************************************!*\
  !*** ./src/app/bewers/bewers.component.html ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "<h2>Bewer List</h2>\n\n<ul class=\"bewers\">\n  <li *ngFor=\"let p of bewers; let i=index;\">\n    <a routerLink=\"/beers?id_bwr={{p.id_bwr}}\">\n      <span class=\"badge\">{{i+1}}</span> {{p.bewer_name}}\n    </a>\n  </li>\n</ul>"

/***/ }),

/***/ "./src/app/bewers/bewers.component.ts":
/*!********************************************!*\
  !*** ./src/app/bewers/bewers.component.ts ***!
  \********************************************/
/*! exports provided: BewersComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BewersComponent", function() { return BewersComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _rest_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../rest.service */ "./src/app/rest.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var BewersComponent = /** @class */ (function () {
    function BewersComponent(rest, route, router) {
        this.rest = rest;
        this.route = route;
        this.router = router;
        this.bewers = [];
    }
    BewersComponent.prototype.ngOnInit = function () {
        this.getBewers();
    };
    BewersComponent.prototype.getBewers = function () {
        var _this = this;
        this.bewers = [];
        this.rest.getBewers().subscribe(function (data) {
            console.log(data);
            _this.bewers = data;
        });
    };
    BewersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-bewers',
            template: __webpack_require__(/*! ./bewers.component.html */ "./src/app/bewers/bewers.component.html"),
            styles: [__webpack_require__(/*! ./bewers.component.css */ "./src/app/bewers/bewers.component.css")]
        }),
        __metadata("design:paramtypes", [_rest_service__WEBPACK_IMPORTED_MODULE_1__["RestService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], BewersComponent);
    return BewersComponent;
}());
...
var endpoint = 'http://lbeer.pl/rest/';
var httpOptions = {
...
var RestService = /** @class */ (function () {
    ...
    RestService.prototype.getBeers = function () {
        return this.http.get(endpoint + 'beers').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData));
    };
    RestService.prototype.getBewers = function () {
        return this.http.get(endpoint + 'bewers').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData));
    };
    RestService.prototype.getBeer = function (id) {
        return this.http.get(endpoint + 'beers/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData));
    };
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\beer-angular\src\main.ts */"./src/main.ts");
